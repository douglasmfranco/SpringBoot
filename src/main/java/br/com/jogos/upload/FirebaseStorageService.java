...
public class FirebaseStorageService {
    ...
    @PostConstruct  // cahamado apenas uma vez se estiver vazia
        ...
        if (FirebaseApp.getApps().isEmpty()) {
            ...
            if(in != null) {
                FirebaseOptions options = new FirebaseOptions.Builder()
                        ...
                        .setStorageBucket("jogos-b1377.appspot.com")
                        .setDatabaseUrl("https://jogos-b1377.firebaseio.com")
                        .build();
...
//        Blob blob = bucket.create("nome.txt","Ricardo Ninja Lecheta".getBytes(), "text/html");
        ...
        byte[] bytes = Base64.getDecoder().decode(uploadInput.getBase64()); //converte para byte
